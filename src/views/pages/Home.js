  ...
  return (
    <>
      ...
      <Main id="main">
        ...
        <section id="services-companies" className="services">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
            ...
            <div className="row">
              ...
              >
                <div className="icon-box iconbox-green">
                  ...
                  <p>
                    Treinamentos especializados com emissão de certificado de
                    conclusão de curso para empresas.
                  </p>
                  <p>
                    Engenharia e Gestão de Segurança, Medicina do Trabalho,
                    Treinamentos Normativos e ESocial.
                  </p>
                </div>
              </div>
            </div>
