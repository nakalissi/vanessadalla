        ...
        <section id="about" className="about">
          <div className="container" data-aos="fade-up">
            <div className="section-title">
              <h2>Sobre Mim</h2>
              <p>
                Sou Vanessa Dalla, consultora de carreira e headhunter, com
                vasta experiência em ajudar profissionais a alcançarem seus
                sonhos e empresas a encontrarem soluções estratégicas em
            ...
            <div className="row content">
              <div className="col-lg-6 col-md-12">
                ...
                <ul>
                  <li>
                    <i className="ri-check-double-line"></i> Conectar
                    organizações aos profissionais ideais, que não apenas
                    impulsionem resultados, mas também contribuam para um
                    ambiente de trabalho harmonioso e inspirador.
                  </li>
                  <li>
                    <i className="ri-check-double-line"></i> Capacitar pessoas a
                    encontrarem o emprego dos seus sonhos, onde possam crescer,
                    se desenvolver e receber o devido reconhecimento por suas
                    contribuições.
                  </li>
                  <li>
                    <i className="ri-check-double-line"></i> Ser referência em
                    consultoria de carreira e recrutamento personalizado no
                    Brasil. Valores: Empatia, transparência, excelência e
                    impacto positivo.
                  </li>
                </ul>
              </div>
